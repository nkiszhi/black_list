...
if __name__ == "__main__":
    ...
    # XGBoost_clf = XGBoost_classifier()
    # XGBoost_clf.load(model_path)
    # # XGBoost_clf.predict_singleDN(model_path, "baijiahao.dsalkswjgoijdslk.com")
    # XGBoost_clf.predict_singleDN(model_path, "www.20fc.org")
...
#    XGBoost_clf = XGBoost_classifier()
#    # XGBoost_clf.train(r"./data/model", r"./data/features/train_features.csv")
#    XGBoost_clf.predict_singleDN(model_path, "www.vinda.com")

    # RF_clf = RF_classifier()
    # # RF_clf.train(model_path, train_add)
    # RF_clf.predict_singleDN(model_path, "baijiahao.com")

#    SVM_clf = SVM_classifier()
#    # SVM_clf.train(model_path, train_add)
#    SVM_clf.predict_singleDN(model_path, "www.vinda.com")
